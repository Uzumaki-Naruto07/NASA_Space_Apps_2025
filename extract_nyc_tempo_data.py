#!/usr/bin/env python3
"""
Extract Real TEMPO Data for NYC & East Coast
============================================

Extract real TEMPO L2 data for NYC & East Coast using the correct structure.
"""
...
def main():
    print("🌍 NYC & East Coast TEMPO Data Extractor")
    print("=" * 60)
    print("Extracting real TEMPO L2 data for NYC & East Coast...")
    print()
    
    # Create output directories
    raw_dir = Path("nyc_tempo_raw_complete")
    raw_dir.mkdir(exist_ok=True)
    
    # NYC & East Coast bash scripts (correct names)
    bash_scripts = [
        "Tempo and weather/NYC & East Coast (Wildfire Smoke Event) 6-7 Jun 2025/Tempo bash converter  /NO2_L2_V03.sh",
        "Tempo and weather/NYC & East Coast (Wildfire Smoke Event) 6-7 Jun 2025/Tempo bash converter  /TEMPO_HCHO_L2_V03.sh",
        "Tempo and weather/NYC & East Coast (Wildfire Smoke Event) 6-7 Jun 2025/Tempo bash converter  /TEMPO_O3TOT_L2_V03.sh"
    ]
    ...
    if all_data:
        print(f"\n🔄 Creating NYC_FULL_Pollutant.csv...")
        ...
        if combined_data:
            ...
            # Save to CSV
            output_file = "NYC_FULL_Pollutant.csv"
