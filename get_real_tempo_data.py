#!/usr/bin/env python3
"""
Get Real TEMPO L2 Data for NASA Competition
===========================================

This script downloads the actual TEMPO L2 data that contains real measurements
of nitrogendioxide_tropospheric_column, formaldehyde_tropospheric_column, etc.

The issue: Your current files are L3 regridded data (spatial weights only)
The solution: Download L2 files with actual pollutant measurements
...
def main():
    print("🌍 NASA TEMPO L2 Data Downloader")
    print("=" * 60)
    ...
    print("L2 files contain the actual pollutant measurements you need!")
    print()
    ...
    # Find bash scripts with L2 URLs
    bash_scripts = [
    ...
    for script_path in bash_scripts:
        ...
        print(f"  Found {len(urls)} L2 URLs")
        
        # Download first few files as test
        test_count = min(5, len(urls))  # Test with first 5 files
